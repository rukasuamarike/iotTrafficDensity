/*
# scripts.js
# Handles the client-side logic for the traffic monitoring system.
# Owen Matejka
# CSEN 143
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchVehicleLogs() {
        try {
            ...
            if (vehicleLogs.length > maxLogEntries) { // Limit the number of logs
    ...
    async function fetchTrafficTrend() {
        try {
            ...
            // Set the trend text and message based on the trend value
